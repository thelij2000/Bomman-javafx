...
public class Enemy1 extends Mob {
    ...
    public static void init() {
        if (balloomImg == null) {
            ...
            try {
                balloomImg.add(new Image((Balloom.class.getResource("/Picture/Ballom/mob4.png").toURI().toString())));
                balloomImg.add(new Image((Balloom.class.getResource("/Picture/Ballom/mob5.png").toURI().toString())));
    ...
    public void draw(GraphicsContext render) {
        move();
        render.drawImage(balloomImg.get(life), getX(), getY());
